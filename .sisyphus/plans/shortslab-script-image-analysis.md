...
- [x] scenes 변경 시 자동 저장(useEffect) 적용 여부 확인
- [x] 이미지 생성 에러 유형 분기 처리 여부 확인
- [x] 씬 번호 정규화 로직 적용 여부 확인
- [x] 의상 폴백 상수화/풀 기반 처리 여부 확인
- [x] JSON 파싱 실패 단계 로깅 적용 여부 확인
...
- 2026-01-23: 후처리 유틸을 `labPromptBuilder.ts`로 이동
- 2026-01-23: scenes 변경 시 자동 저장(useEffect) 추가
- 2026-01-23: 이미지 생성 에러 분기 처리 강화
- 2026-01-23: 씬 삭제 시 번호 정규화 적용
- 2026-01-23: 의상 폴백을 풀 기반 선택으로 개선
- 2026-01-23: JSON 파싱 실패 단계 로깅 추가
- 2026-01-23: ShortsLab 전용 장르 관리자/훅 추가 및 장르 관리 UI 연결
