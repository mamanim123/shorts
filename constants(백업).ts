...
// prompt: 이미지 생성용 상세 영문 프롬프트
export const UNIFIED_OUTFIT_LIST = [
  // [Style 1: Royal Signature] - 10 elegant styles
  { 
    id: "royal-001", 
    name: "White Sleeveless Turtleneck + Navy Leather Mini Skirt", 
    translation: "화이트 슬리브리스 터틀넥 + 네이비 가죽 미니스커트", 
    categories: ["ROYAL"],
    prompt: "white sleeveless turtleneck top in soft ribbed knit fabric with fitted silhouette, paired with high-waisted navy blue genuine leather mini skirt with back zipper closure, polished silver hardware details"
  },
  { 
    id: "royal-002", 
    name: "White Halter-neck Tight Crop Top + Tight Blue Jeans", 
    translation: "화이트 홀터넥 타이트 크롭탑 + 타이트 블루 진", 
    categories: ["ROYAL"],
    prompt: "white halter-neck crop top in stretchy cotton blend with tie closure at neck, bodycon fit exposing midriff, paired with high-waisted tight-fitting blue denim jeans with slight stretch, classic five-pocket styling"
  },
  { 
    id: "royal-003", 
    name: "White See-through Blouse + Royal Blue Tight Micro Skirt", 
    translation: "화이트 시스루 블라우스 + 로열 블루 타이트 마이크로 스커트", 
    categories: ["ROYAL"],
    prompt: "white sheer chiffon blouse with delicate fabric, long sleeves with button cuffs, subtle transparency showing undergarment silhouette, paired with royal blue bodycon micro mini skirt in stretchy fabric, high-waisted with back zipper"
  },
  { 
    id: "royal-004", 
    name: "White Off-shoulder Tube Top + Navy Mini Skirt", 
    translation: "화이트 오프숄더 튜브탑 + 네이비 미니스커트", 
    categories: ["ROYAL"],
    prompt: "white off-shoulder tube top in elastic cotton blend with smocked back panel for secure fit, strapless design, paired with navy blue A-line mini skirt with concealed side zipper, subtle pleating at waist"
  },
  { 
    id: "royal-005", 
    name: "Navy Blue Textured Tweed Deep V-neck Tight Mini Dress", 
    translation: "네이비 블루 텍스처 트위드 딥 V넥 타이트 미니 드레스", 
    categories: ["ROYAL"],
    prompt: "navy blue textured tweed mini dress with deep plunging V-neckline, bodycon silhouette with structured shoulders, gold-tone button details along front, frayed hem edges, fully lined"
  },
  { 
    id: "royal-006", 
    name: "White Silk Deep V-neck Blouse + Royal Blue Tight Micro Mini Skirt", 
    translation: "화이트 실크 딥 V넥 블라우스 + 로열 블루 타이트 마이크로 미니스커트", 
    categories: ["ROYAL"],
    prompt: "white pure silk blouse with deep V-neckline and draped front, long sleeves with French cuffs, lustrous sheen finish, paired with royal blue lycra micro mini skirt with ultra-high waist, figure-hugging fit"
  },
  { 
    id: "royal-007", 
    name: "Navy Off-shoulder Tight Knit + White Micro Mini Skirt", 
    translation: "네이비 오프숄더 타이트 니트 + 화이트 마이크로 미니스커트", 
    categories: ["ROYAL"],
    prompt: "navy blue off-shoulder knit sweater in fine merino wool, fitted bodice with ribbed texture, elastic neckline for secure off-shoulder styling, paired with white micro mini skirt in ponte fabric, bodycon fit with invisible zipper"
  },
  { 
    id: "royal-008", 
    name: "White Lace Crop Top + Deep Blue Satin Micro Mini Skirt", 
    translation: "화이트 레이스 크롭탑 + 딥 블루 새틴 마이크로 미니 스커트", 
    categories: ["ROYAL"],
    prompt: "white floral lace crop top with scalloped edges, sheer overlay with nude lining at bust, short cap sleeves, paired with deep blue satin micro mini skirt with high-shine finish, high-waisted with smooth drape"
  },
  { 
    id: "royal-009", 
    name: "Royal Blue Sleeveless Turtleneck + White Micro Mini Skirt", 
    translation: "로열 블루 슬리브리스 터틀넥 + 화이트 마이크로 미니스커트", 
    categories: ["ROYAL"],
    prompt: "royal blue sleeveless turtleneck in fine-gauge knit, fitted silhouette with ribbed collar, smooth body-skimming fit, paired with white micro mini skirt in stretch crepe fabric, clean minimal design with side seam zipper"
  },
  { 
    id: "royal-010", 
    name: "White Chiffon Shirt (Unbuttoned) + Navy Lace Micro Mini Skirt", 
    translation: "화이트 시폰 셔츠(언버튼) + 네이비 레이스 마이크로 미니스커트", 
    categories: ["ROYAL"],
    prompt: "white sheer chiffon button-down shirt worn partially unbuttoned showing décolletage, oversized relaxed fit with rolled sleeves, paired with navy blue lace micro mini skirt with scalloped hem, nude underlining, high-waisted fit"
  },

  // [Style 2: Yoga Fitness] - 10 athletic chic styles
  { 
    id: "yoga-001", 
    name: "White Sports Bra + High-waist Pink Tight Leggings", 
    translation: "화이트 스포츠 브라 + 하이웨이스트 핑크 타이트 레깅스", 
    categories: ["YOGA"],
    prompt: "white compression sports bra with racerback design, removable padding, moisture-wicking fabric with mesh ventilation panels, paired with high-waisted pink leggings in four-way stretch fabric, seamless construction with tummy control waistband"
  },
  { 
    id: "yoga-002", 
    name: "Lavender Crop Tank Top + Black High-waist Tight Leggings", 
    translation: "라벤더 크롭 탱크탑 + 블랙 하이웨이스트 타이트 레깅스", 
    categories: ["YOGA"],
    prompt: "lavender purple cropped tank top with built-in shelf bra, scoop neckline, ribbed fabric with slight sheen, paired with black high-waisted compression leggings in buttery-soft fabric, second-skin fit with hidden pocket at waistband"
  },
  { 
    id: "yoga-003", 
    name: "Mint Racerback Sports Bra + White High-waist Tight Leggings", 
    translation: "민트 레이서백 스포츠 브라 + 화이트 하이웨이스트 타이트 레깅스", 
    categories: ["YOGA"],
    prompt: "mint green racerback sports bra with strappy back detail, medium support with removable cups, breathable mesh lining, paired with white high-waisted leggings in opaque compression fabric, ankle-length with flattering seam placement"
  },
  { 
    id: "yoga-004", 
    name: "Coral Halter Crop Top + Grey High-waist Tight Leggings", 
    translation: "코랄 홀터 크롭탑 + 그레이 하이웨이스트 타이트 레깅스", 
    categories: ["YOGA"],
    prompt: "coral pink halter-neck crop top with keyhole front detail, adjustable tie at neck, cropped length ending above navel, paired with heather grey high-waisted leggings with wide comfort waistband, squat-proof fabric"
  },
  { 
    id: "yoga-005", 
    name: "Black Mesh Panel Sports Bra + Beige High-waist Tight Leggings", 
    translation: "블랙 메쉬 패널 스포츠 브라 + 베이지 하이웨이스트 타이트 레깅스", 
    categories: ["YOGA"],
    prompt: "black sports bra with strategic mesh panel inserts for ventilation, medium-high support with thick elastic band, modern geometric cutouts, paired with beige nude-tone high-waisted leggings in seamless knit construction, second-skin fit"
  },
  { 
    id: "yoga-006", 
    name: "Baby Blue Crop Tank + White High-waist Tight Leggings", 
    translation: "베이비 블루 크롭 탱크 + 화이트 하이웨이스트 타이트 레깅스", 
    categories: ["YOGA"],
    prompt: "baby blue cropped tank top with square neckline, thick shoulder straps, ribbed cotton-blend fabric with slight crop, paired with white high-waisted leggings in thick opaque fabric, compression fit with reinforced gusset"
  },
  { 
    id: "yoga-007", 
    name: "Rose Pink Long-sleeve Crop Top + Black Sculpt Tight Leggings", 
    translation: "로즈 핑크 롱슬리브 크롭탑 + 블랙 스컬프트 타이트 레깅스", 
    categories: ["YOGA"],
    prompt: "dusty rose pink long-sleeve crop top with thumbholes, fitted stretch fabric, cropped length at natural waist, paired with black sculpting leggings with contouring seam lines, high-waisted with smoothing compression panels"
  },
  { 
    id: "yoga-008", 
    name: "Sage Green Sports Bra + Nude Seamless Tight Leggings", 
    translation: "세이지 그린 스포츠 브라 + 누드 심리스 타이트 레깅스", 
    categories: ["YOGA"],
    prompt: "sage green sports bra with v-neckline, thin cross-back straps, light support with removable padding, paired with nude beige seamless leggings with ribbed texture, high-waisted with no visible seams, body-hugging fit"
  },
  { 
    id: "yoga-009", 
    name: "Peach Ribbed Crop Tank + Charcoal High-waist Tight Leggings", 
    translation: "피치 골지 크롭 탱크 + 차콜 하이웨이스트 타이트 레깅스", 
    categories: ["YOGA"],
    prompt: "peach orange ribbed crop tank with racer-style back, thick ribbed cotton fabric, form-fitting silhouette, paired with charcoal grey high-waisted leggings in matte finish fabric, ankle-length with side pocket"
  },
  { 
    id: "yoga-010", 
    name: "Lilac Seamless Crop Top + White High-waist Tight Leggings", 
    translation: "라일락 심리스 크롭탑 + 화이트 하이웨이스트 타이트 레깅스", 
    categories: ["YOGA"],
    prompt: "lilac purple seamless crop top with subtle rib texture, long-line design with built-in support, no visible seams for smooth look, paired with white high-waisted seamless leggings with gradient compression zones"
  },

  // [Style 5: Golf Field Luxury] - Curated 37 styles for 골프장 시나리오
  { 
    id: "golf-001", 
    name: "White Halter-neck Knit + Red Micro Mini Skirt", 
    translation: "화이트 홀터넥 니트 + 레드 마이크로 미니스커트", 
    categories: ["GOLF LUXURY"],
    prompt: "white halter-neck knit top in fine cotton blend, ribbed texture with tie closure at nape, fitted bodice with elegant drape, paired with bright red micro mini skirt in stretch twill fabric, pleated front with gold button detail"
  },
  { 
    id: "golf-002", 
    name: "V-neck Tight Polo Shirt + Micro Mini Skirt", 
    translation: "V넥 타이트 폴로셔츠 + 마이크로 미니스커트", 
    categories: ["GOLF LUXURY"],
    prompt: "fitted V-neck polo shirt in performance pique fabric, contrasting collar trim, three-button placket with logo embroidery, paired with white micro mini skirt in technical stretch fabric, built-in shorts underneath, pleated design"
  },
  { 
    id: "golf-003", 
    name: "Pink Sleeveless Polo + White Tight Wrap Mini Skirt", 
    translation: "핑크 슬리브리스 폴로 + 화이트 타이트 랩 미니스커트", 
    categories: ["GOLF LUXURY"],
    prompt: "soft pink sleeveless polo in moisture-wicking fabric, pointed collar with contrast piping, slim fit silhouette, paired with white wrap-style mini skirt with asymmetric hem, tie waist detail, stretchy ponte fabric"
  },
  { 
    id: "golf-004", 
    name: "White Tube Top + White Tennis Skirt", 
    translation: "화이트 튜브탑 + 화이트 테니스 스커트", 
    categories: ["GOLF LUXURY"],
    prompt: "white strapless tube top in supportive stretch fabric, smocked back panel, clean minimal design with slight sweetheart neckline, paired with white pleated tennis skirt with built-in compression shorts, knife pleats all around"
  },
  { 
    id: "golf-005", 
    name: "Tight Golf Mini One-piece (Belted)", 
    translation: "타이트 골프 미니 원피스 (벨트 장식)", 
    categories: ["GOLF LUXURY"],
    prompt: "fitted golf mini dress in technical stretch fabric, sleeveless design with mock neckline, bodycon silhouette with matching fabric belt at waist, gold buckle closure, above-knee length with subtle ventilation mesh panels"
  },
  { 
    id: "golf-006", 
    name: "Navy Sleeveless Polo + White Micro Skirt with Navy Trim", 
    translation: "네이비 슬리브리스 폴로 + 화이트 마이크로 스커트(네이비 트림)", 
    categories: ["GOLF LUXURY"],
    prompt: "navy blue sleeveless polo shirt in breathable pique, button placket with contrasting white inner collar, fitted cut, paired with white micro mini skirt featuring navy blue trim at hem, pleated front with hidden shorts"
  },
  { 
    id: "golf-007", 
    name: "White Zip-up Vest + Navy Turtleneck + White Micro Skirt", 
    translation: "화이트 지퍼 베스트 + 네이비 터틀넥 + 화이트 마이크로 스커트", 
    categories: ["GOLF LUXURY"],
    prompt: "white quilted zip-up vest with stand collar and front pockets over navy blue fitted turtleneck in fine knit, layered look, paired with white micro mini skirt in stretch fabric with side zipper, clean A-line silhouette"
  },
  { 
    id: "golf-008", 
    name: "Red Cap-sleeve Tight Tee + White Micro Skirt", 
    translation: "레드 캡소매 타이트 티 + 화이트 마이크로 스커트", 
    categories: ["GOLF LUXURY"],
    prompt: "bright red cap-sleeve fitted tee in soft stretch jersey, crew neckline, body-hugging fit with short flutter sleeves, paired with white micro mini skirt in performance fabric, flat front with back elastic waistband"
  },
  { 
    id: "golf-009", 
    name: "Black Sleeveless High-neck Top + Beige Micro Pleated Skirt", 
    translation: "블랙 슬리브리스 하이넥 탑 + 베이지 마이크로 플리츠 스커트", 
    categories: ["GOLF LUXURY"],
    prompt: "black sleeveless high-neck top in smooth technical fabric, mock turtleneck with back zipper, fitted athletic silhouette, paired with beige micro pleated mini skirt with permanent knife pleats, lightweight polyester blend"
  },
  { 
    id: "golf-010", 
    name: "Pink & White Striped Knit + White Micro Short Pants", 
    translation: "핑크&화이트 스트라이프 니트 + 화이트 마이크로 쇼츠", 
    categories: ["GOLF LUXURY"],
    prompt: "pink and white horizontal striped knit top with boat neckline, short sleeves in lightweight cotton blend, relaxed fit, paired with white micro shorts in stretch twill, high-waisted with front pleats and side pockets"
  },
  { 
    id: "golf-011", 
    name: "Black Sleeveless Turtleneck + White Micro Pleated Skirt (Monochrome Chic)", 
    translation: "블랙 슬리브리스 터틀넥 + 화이트 마이크로 플리츠 스커트", 
    categories: ["GOLF LUXURY"],
    prompt: "black sleeveless turtleneck in fine ribbed knit, slim fit with folded collar, elegant minimalist design, paired with white micro pleated mini skirt with all-around knife pleats, lightweight fabric with subtle sheen"
  },
  { 
    id: "golf-012", 
    name: "Beige Halter-neck Knit + Navy Tight Mini Skirt (Elegant)", 
    translation: "베이지 홀터넥 니트 + 네이비 타이트 미니스커트", 
    categories: ["GOLF LUXURY"],
    prompt: "beige halter-neck knit top with ribbed texture, tie closure at back of neck, fitted bodice with elegant drape, paired with navy blue bodycon mini skirt in ponte fabric, high-waisted with invisible back zipper"
  },
  { 
    id: "golf-013", 
    name: "Dark Green Sleeveless Polo + White Micro Shorts (Sophisticated Sporty)", 
    translation: "다크 그린 슬리브리스 폴로 + 화이트 마이크로 쇼츠", 
    categories: ["GOLF LUXURY"],
    prompt: "dark forest green sleeveless polo in premium pique fabric, ribbed collar with three-button placket, fitted athletic cut, paired with white micro shorts in stretch woven fabric, mid-rise with flat front and back welt pockets"
  },
  { 
    id: "golf-014", 
    name: "Navy Zip-up Sleeveless Vest + White Tight Micro Skirt (Professional)", 
    translation: "네이비 지퍼 슬리브리스 베스트 + 화이트 타이트 마이크로 스커트", 
    categories: ["GOLF LUXURY"],
    prompt: "navy blue sleeveless zip-up vest in technical fabric, stand collar with full-length zipper, fitted silhouette with side mesh panels, paired with white tight micro mini skirt in stretch crepe, bodycon fit with back slit"
  },
  { 
    id: "golf-015", 
    name: "White Mock-neck Sleeveless + Burgundy Micro Mini Skirt (Color Point)", 
    translation: "화이트 목넥 슬리브리스 + 버걔디 마이크로 미니스커트", 
    categories: ["GOLF LUXURY"],
    prompt: "white mock-neck sleeveless top in smooth performance fabric, high neckline with back zipper, clean athletic silhouette, paired with burgundy wine micro mini skirt in stretch satin, high-waisted with subtle sheen"
  },
  { 
    id: "golf-016", 
    name: "Pink Tight Polo Shirt + White Micro Mini Skirt (Lovely Sporty)", 
    translation: "핑크 타이트 폴로 셔츠 + 화이트 마이크로 미니스커트", 
    categories: ["GOLF LUXURY"],
    prompt: "soft pink fitted polo shirt in stretchy pique fabric, pointed collar with contrast trim, short sleeves with ribbed cuffs, paired with white micro mini skirt with front pleats, built-in shorts, lightweight technical fabric"
  },
  { 
    id: "golf-017", 
    name: "Black Cross-strap Halter Top + White Micro Mini Skirt (Black & White Sexy)", 
    translation: "블랙 크로스 스트랩 홀터탑 + 화이트 마이크로 미니스커트", 
    categories: ["GOLF LUXURY"],
    prompt: "black halter top with crossed straps at back, deep V-neckline, fitted stretch fabric with supportive built-in bra, paired with white micro mini skirt in crisp cotton blend, A-line silhouette with hidden zipper"
  },
  { 
    id: "golf-018", 
    name: "Grey Ribbed Knit Tight Mini Dress (Modern Chic)", 
    translation: "그레이 골지 니트 타이트 미니 드레스", 
    categories: ["GOLF LUXURY"],
    prompt: "grey ribbed knit bodycon mini dress with mock neckline, sleeveless design, vertical rib texture creating slimming effect, figure-hugging fit ending mid-thigh, back zipper closure"
  },
  { 
    id: "golf-019", 
    name: "White See-through Shirt + White High-waist Hot Pants (Pure Luxury)", 
    translation: "화이트 시스루 셔츠 + 화이트 하이웨이스트 핫팬츠", 
    categories: ["GOLF LUXURY"],
    prompt: "white sheer organza button-down shirt with visible white bralette underneath, oversized relaxed fit, long sleeves rolled up, paired with white high-waisted hot pants in stretch denim, ultra-short length with frayed hem"
  },
  { 
    id: "golf-020", 
    name: "Charcoal Sleeveless Mock-neck + Black Micro Pleated Skirt (Dark Luxury)", 
    translation: "차콜 슬리브리스 목넥 + 블랙 마이크로 플리츠 스커트", 
    categories: ["GOLF LUXURY"],
    prompt: "charcoal grey sleeveless mock-neck top in fine jersey, fitted silhouette with subtle sheen, modern minimalist design, paired with black micro pleated mini skirt with permanent knife pleats, lightweight fabric with movement"
  },
  { 
    id: "golf-021", 
    name: "Grey Halter-neck Tight Mini Dress (Sleek)", 
    translation: "그레이 홀터넥 타이트 미니 드레스", 
    categories: ["GOLF LUXURY"],
    prompt: "heather grey halter-neck bodycon mini dress in stretch ponte fabric, deep halter neckline with tie at nape, figure-hugging silhouette ending above knee, open back design with elegant drape"
  },
  { 
    id: "golf-022", 
    name: "Peach Silk Camisole + White High-waist Micro Skirt (Soft Luxury)", 
    translation: "피치 실크 캐미솔 + 화이트 하이웨이스트 마이크로 스커트", 
    categories: ["GOLF LUXURY"],
    prompt: "peach pink silk camisole with delicate spaghetti straps, cowl neckline with lace trim, lustrous finish with subtle drape, paired with white high-waisted micro mini skirt in structured cotton, clean A-line silhouette"
  },
  { 
    id: "golf-023", 
    name: "White Long-sleeve V-neck Tight Mini Dress (Clean Sexy)", 
    translation: "화이트 롱슬리브 V넥 타이트 미니 드레스", 
    categories: ["GOLF LUXURY"],
    prompt: "white long-sleeve bodycon mini dress with deep V-neckline, fitted stretch jersey fabric, form-fitting silhouette ending mid-thigh, subtle ruching at sides for flattering fit"
  },
  { 
    id: "golf-024", 
    name: "Grey Checkered Jacket Mini Dress (Classy Field)", 
    translation: "그레이 체크 자켓 미니 드레스", 
    categories: ["GOLF LUXURY"],
    prompt: "grey and white houndstooth check blazer-style mini dress with notched lapels, double-breasted gold button closure, long sleeves with functional cuffs, A-line skirt portion ending above knee"
  },
  { 
    id: "golf-025", 
    name: "Beige & White Argyle Check V-neck Set (Glitz & Glam)", 
    translation: "베이지&화이트 아가일 체크 V넥 세트", 
    categories: ["GOLF LUXURY"],
    prompt: "beige and white argyle pattern V-neck sweater vest over white collared shirt, classic preppy layered look, paired with matching beige pleated mini skirt with argyle trim at hem"
  },
  { 
    id: "golf-026", 
    name: "Emerald green tight bodycon golf mini dress with high mock neckline and oval cutout on side waist", 
    translation: "에메랄드 그린 바디콘 골프 미니 드레스 (하이 목넥, 사이드 허리 컷아웃)", 
    categories: ["GOLF LUXURY"],
    prompt: "emerald green bodycon golf mini dress in technical stretch fabric, high mock neckline with back zipper, oval-shaped cutout details on both sides at waist, sleeveless athletic silhouette ending mid-thigh"
  },
  { 
    id: "golf-027", 
    name: "Ivory Bodycon Blazer Mini Dress with Pleated Hem", 
    translation: "아이보리 바디콘 블레이저 미니 드레스(플리츠 헴)", 
    categories: ["GOLF LUXURY"],
    prompt: "ivory cream bodycon mini dress with blazer-style top featuring notched lapels and single button closure, fitted bodice transitioning to pleated skirt hem, long sleeves with gold button cuffs"
  },
  { 
    id: "golf-028", 
    name: "Champagne Satin Racerback Golf Mini Dress", 
    translation: "샴페인 새틴 레이서백 골프 미니 드레스", 
    categories: ["GOLF LUXURY"],
    prompt: "champagne gold satin mini dress with racerback athletic styling, high neckline in front with dramatic open back, fitted silhouette with slight flare at hem, lustrous finish catching light"
  },
  { 
    id: "golf-029", 
    name: "Navy One-shoulder Pleated Mini Dress", 
    translation: "네이비 원숄더 플리츠 미니 드레스", 
    categories: ["GOLF LUXURY"],
    prompt: "navy blue one-shoulder mini dress with asymmetric neckline, single wide strap on one shoulder, fitted bodice with pleated A-line skirt portion, sophisticated draped fabric"
  },
  { 
    id: "golf-030", 
    name: "Blush Draped Halter Mini Dress with Belted Waist", 
    translation: "블러시 드레이프 홀터 미니 드레스(벨트 허리)", 
    categories: ["GOLF LUXURY"],
    prompt: "blush pink halter mini dress with elegant draping at bodice, deep V-neckline with neck tie closure, matching fabric belt cinching waist, flowing A-line skirt in lightweight chiffon"
  },
  { 
    id: "golf-031", 
    name: "Black Zip-front Sculpted Golf Mini Dress", 
    translation: "블랙 지퍼 프런트 스컬프트 골프 미니 드레스", 
    categories: ["GOLF LUXURY"],
    prompt: "black sculpted golf mini dress with front zipper from neckline to hem, mock collar, contoured seaming for body-shaping effect, sleeveless athletic design in technical stretch fabric"
  },
  { 
    id: "golf-032", 
    name: "Lavender Structured Puff-sleeve Mini Dress", 
    translation: "라벤더 스트럭처드 퍼프 슬리브 미니 드레스", 
    categories: ["GOLF LUXURY"],
    prompt: "lavender purple mini dress with structured puff sleeves, square neckline, fitted bodice with princess seams, A-line skirt with slight volume, romantic feminine silhouette"
  },
  { 
    id: "golf-033", 
    name: "Silver Glossy Panel Mini Dress with Mesh Insets", 
    translation: "실버 글로시 패널 미니 드레스(메쉬 인셋)", 
    categories: ["GOLF LUXURY"],
    prompt: "metallic silver mini dress with high-shine glossy panels, strategic black mesh insets at sides for ventilation, mock neckline, sleeveless futuristic athletic design"
  },
  { 
    id: "golf-034", 
    name: "Teal Mock-wrap Mini Dress with Contrast Piping", 
    translation: "틸 모크 랩 미니 드레스(콘트라스트 파이핑)", 
    categories: ["GOLF LUXURY"],
    prompt: "teal blue mock-wrap mini dress with faux wrap front creating V-neckline, white contrast piping along edges and waistline, short cap sleeves, flattering A-line skirt"
  },
  { 
    id: "golf-035", 
    name: "Coral Ruched Off-shoulder Mini Dress", 
    translation: "코랄 루치드 오프숄더 미니 드레스", 
    categories: ["GOLF LUXURY"],
    prompt: "coral orange off-shoulder mini dress with ruched bodice creating gathered texture, elastic neckline for secure fit, bodycon silhouette with slight stretch, ending above knee"
  },

  // SEXY 의상 (불륜/외도 장르 전용)
  { 
    id: "sexy-001", 
    name: "Black Lace Corset Top + Black Satin Micro Mini Skirt", 
    translation: "블랙 레이스 코르셋 탑 + 블랙 새틴 마이크로 미니스커트", 
    categories: ["SEXY"],
    prompt: "black floral lace corset top with boned structure, sweetheart neckline, hook-and-eye front closure with ribbon lacing at back, paired with black satin micro mini skirt with high-shine finish, ultra-short length"
  },
  { 
    id: "sexy-002", 
    name: "Red See-through Lingerie Style Mini Dress", 
    translation: "레드 시스루 란제리 스타일 미니 드레스", 
    categories: ["SEXY"],
    prompt: "red sheer mesh mini dress in lingerie style with visible bra and panty underneath, delicate lace trim at neckline and hem, spaghetti straps, body-skimming fit ending mid-thigh"
  },
  { 
    id: "sexy-003", 
    name: "White Silk Slip Mini Dress (Short)", 
    translation: "화이트 실크 슬립 미니 드레스 (숏)", 
    categories: ["SEXY"],
    prompt: "white pure silk slip mini dress with cowl neckline, thin spaghetti straps, bias-cut for fluid drape against body, delicate lace trim at bodice, ending high on thigh"
  },
  { 
    id: "sexy-004", 
    name: "Black Leather Harness Detail Bodycon Dress", 
    translation: "블랙 레더 하네스 디테일 바디콘 드레스", 
    categories: ["SEXY"],
    prompt: "black bodycon mini dress with faux leather harness straps crossing over bodice, edgy bondage-inspired design, sleeveless with high neckline, figure-hugging stretch fabric"
  },
  { 
    id: "sexy-005", 
    name: "Nude Tone Mesh Bodysuit + Tight Leather Skirt", 
    translation: "누드톤 메쉬 보디수트 + 타이트 가죽 스커트", 
    categories: ["SEXY"],
    prompt: "nude beige sheer mesh bodysuit with strategic opaque panels, long sleeves, mock neckline, second-skin fit, paired with black tight leather mini skirt with high waist, back zipper"
  },
  { 
    id: "sexy-006", 
    name: "Burgundy Velvet Corset Mini Dress", 
    translation: "버건디 벨벳 코르셋 미니 드레스", 
    categories: ["SEXY"],
    prompt: "burgundy wine velvet mini dress with built-in corset bodice, boning structure visible, sweetheart neckline with thin straps, fitted through body with slight flare at hem"
  },
  { 
    id: "sexy-007", 
    name: "Black Sheer Blouse (Black Bra Visible) + Tight Micro Skirt", 
    translation: "블랙 시어 블라우스 (블랙 브라 노출) + 타이트 마이크로 스커트", 
    categories: ["SEXY"],
    prompt: "black sheer chiffon blouse showing black lace bra underneath, long sleeves with button cuffs, partially unbuttoned, paired with black bodycon micro mini skirt in stretch fabric"
  },
  { 
    id: "sexy-008", 
    name: "Silver Metallic Mini Dress with Crystal details", 
    translation: "실버 메탈릭 미니 드레스 (크리스털 디테일)", 
    categories: ["SEXY"],
    prompt: "silver metallic mini dress with reflective chainmail-like texture, crystal rhinestone embellishments along neckline and straps, spaghetti strap design, body-hugging fit"
  },
  { 
    id: "sexy-009", 
    name: "Pink Satin Bustier Top + White Hot Pants", 
    translation: "핑크 새틴 뷔스티에 탑 + 화이트 핫팬츠", 
    categories: ["SEXY"],
    prompt: "hot pink satin bustier top with structured cups, boning at sides, sweetheart neckline, paired with white denim hot pants with ultra-short inseam, high-waisted with frayed hem"
  },
  { 
    id: "sexy-010", 
    name: "Leopard Print V-neck Tight Mini Dress", 
    translation: "레오파드 프린트 V넥 타이트 미니 드레스", 
    categories: ["SEXY"],
    prompt: "leopard print bodycon mini dress with deep V-neckline, animal print in brown and black tones, long sleeves, ruched sides for figure flattery, ending mid-thigh"
  },

  // 남성 의상 (기존 MALE_OUTFIT_PRESETS 활용)
  { 
    id: "male-001", 
    name: "Navy Slim-fit Polo + White Tailored Golf Pants", 
    translation: "네이비 슬림핏 폴로 + 화이트 테일러드 골프 팬츠", 
    categories: ["MALE", "GOLF"],
    prompt: "navy blue slim-fit polo shirt in premium pique cotton, ribbed collar and cuffs, three-button placket with subtle logo embroidery, paired with white tailored golf pants in stretch twill, flat front with belt loops"
  },
  { 
    id: "male-002", 
    name: "White Performance Polo + Beige Chino Golf Pants", 
    translation: "화이트 퍼포먼스 폴로 + 베이지 치노 골프 팬츠", 
    categories: ["MALE", "GOLF"],
    prompt: "white performance polo shirt in moisture-wicking technical fabric, athletic fit with mesh ventilation panels, paired with beige chino golf pants in lightweight cotton blend, tailored straight leg"
  },
  { 
    id: "male-003", 
    name: "Charcoal Mock-neck Knit + Grey Checkered Slacks", 
    translation: "차콜 목넥 니트 + 그레이 체크 슬랙스", 
    categories: ["MALE", "BUSINESS"],
    prompt: "charcoal grey mock-neck sweater in fine merino wool, ribbed collar and cuffs, fitted silhouette, paired with grey glen check patterned dress slacks, flat front with pressed crease"
  },
  { 
    id: "male-004", 
    name: "Burgundy Half-zip Pullover + Cream Pants", 
    translation: "버건디 하프집 풀오버 + 크림 팬츠", 
    categories: ["MALE", "CASUAL"],
    prompt: "burgundy wine half-zip pullover sweater in cotton-cashmere blend, stand collar with metal zipper, relaxed fit, paired with cream ivory dress pants in lightweight wool, pleated front"
  },
  { 
    id: "male-005", 
    name: "White Shirt + Navy Blazer + Grey Slacks", 
    translation: "화이트 셔츠 + 네이비 블레이저 + 그레이 슬랙스", 
    categories: ["MALE", "BUSINESS"],
    prompt: "crisp white cotton dress shirt with spread collar, worn under navy blue single-breasted blazer with gold buttons, notched lapels, paired with medium grey wool dress slacks, tailored fit"
  },
  { 
    id: "male-006", 
    name: "Charcoal Double-breasted Suit + Black Tie", 
    translation: "차콜 더블브레스트 슈트 + 블랙 타이", 
    categories: ["MALE", "BUSINESS"],
    prompt: "charcoal grey double-breasted suit jacket with peak lapels, six-button closure, worn with matching trousers, white dress shirt underneath, black silk necktie in classic knot"
  },
  { 
    id: "male-007", 
    name: "Beige Cashmere Turtleneck + White Trousers", 
    translation: "베이지 캐시미어 터틀넥 + 화이트 트라우저스", 
    categories: ["MALE", "CASUAL"],
    prompt: "beige camel cashmere turtleneck sweater with folded collar, soft luxurious texture, fitted silhouette, paired with white cotton trousers with flat front, tapered leg"
  },
  { 
    id: "male-008", 
    name: "Black Knit Polo + Dark Indigo Denim", 
    translation: "블랙 니트 폴로 + 다크 인디고 데님", 
    categories: ["MALE", "CASUAL"],
    prompt: "black fine-knit polo shirt with ribbed collar, short sleeves, slim fit silhouette, paired with dark indigo blue jeans in premium denim, slim straight fit with subtle whiskering"
  },
  { 
    id: "male-009", 
    name: "Dark Green Bomber Jacket + Black Slacks", 
    translation: "다크 그린 봄버 재킷 + 블랙 슬랙스", 
    categories: ["MALE", "CASUAL"],
    prompt: "dark forest green nylon bomber jacket with ribbed collar and cuffs, front zipper closure, two side pockets, paired with black wool-blend dress slacks, flat front tailored fit"
  },
  { 
    id: "male-010", 
    name: "White Oxford Shirt + Camel Coat + Navy Slacks", 
    translation: "화이트 옥스퍼드 셔츠 + 카멜 코트 + 네이비 슬랙스", 
    categories: ["MALE", "BUSINESS"],
    prompt: "white oxford cloth button-down shirt with button-down collar, worn under camel tan wool overcoat with notched lapels, knee length, paired with navy blue dress trousers"
  },
  { 
    id: "male-011", 
    name: "All Black Casual Suit (Black Turtleneck + Black Slacks)", 
    translation: "올 블랙 캐주얼 슈트 (블랙 터틀넥 + 블랙 슬랙스)", 
    categories: ["MALE", "CASUAL"],
    prompt: "all-black monochromatic outfit with black fine-knit turtleneck sweater, fitted silhouette, paired with black wool dress slacks, flat front with subtle sheen, sleek minimalist look"
  },
  { 
    id: "male-012", 
    name: "Light Grey Linen Shirt + White Pants", 
    translation: "라이트 그레이 리넨 셔츠 + 화이트 팬츠", 
    categories: ["MALE", "CASUAL"],
    prompt: "light grey linen button-down shirt with natural texture, relaxed fit with rolled sleeves, paired with white cotton chino pants, relaxed straight leg, casual summer style"
  }
];
