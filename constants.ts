...
export const UNIFIED_OUTFIT_LIST = [
  ...
  { id: "royal-014", name: "Champagne Silk Halter + Ivory Mini Skirt", translation: "샴페인 실크 홀터넥 + 아이보리 미니스커트", categories: ["ROYAL"] },
  { id: "royal-015", name: "Royal Blue Velvet Mini Dress with Gold Chain", translation: "로열 블루 벨벳 미니 드레스 (골드 체인 장식)", categories: ["ROYAL"] },
  { id: "royal-016", name: "White Lace Off-shoulder + Navy Satin Skirt", translation: "화이트 레이스 오프숄더 + 네이비 새틴 스커트", categories: ["ROYAL"] },
  { id: "royal-017", name: "Emerald Green Silk Blouse + Black Shorts", translation: "에메랄드 그린 실크 블라우스 + 블랙 숏팬츠", categories: ["ROYAL"] },
  { id: "royal-018", name: "Cream Tweed Sleeveless Mini Dress", translation: "크림 트위드 슬리브리스 미니 드레스", categories: ["ROYAL"] },
  { id: "royal-019", name: "Navy Blue See-through Knit + White Micro Mini Skirt", translation: "네이비 블루 시스루 니트 + 화이트 마이크로 미니스커트", categories: ["ROYAL"] },
  { id: "royal-020", name: "Royal Blue One-shoulder Silk Dress", translation: "로열 블루 원숄더 실크 드레스", categories: ["ROYAL"] },
  { id: "royal-021", name: "Ivory Cashmere Turtleneck + Navy Plaid Mini Skirt", translation: "아이보리 캐시미어 터틀넥 + 네이비 체크 미니스커트", categories: ["ROYAL"] },
  { id: "royal-022", name: "Burgundy Silk Wrap Top + White Micro Slacks", translation: "버건디 실크 랩 탑 + 화이트 마이크로 슬랙스", categories: ["ROYAL"] },
  { id: "royal-023", name: "Black Sheer Lace Bodysuit + Royal Blue Satin Skirt", translation: "블랙 시어 레이스 바디수트 + 로열 블루 새틴 스커트", categories: ["ROYAL"] },
  { id: "royal-024", name: "White Puff Sleeve Silk Top + Emerald Mini Skirt", translation: "화이트 퍼프 슬리브 실크 탑 + 에메랄드 미니스커트", categories: ["ROYAL"] },
  { id: "royal-025", name: "Deep Navy Halter Tight Dress with Pearl Buttons", translation: "딥 네이비 홀터 타이트 드레스 (진주 단추)", categories: ["ROYAL"] },
  { id: "royal-026", name: "Champagne Gold Satin Slip + Navy Lace Trim", translation: "샴페인 골드 새틴 슬립 + 네이비 레이스 트림", categories: ["ROYAL"] },
  { id: "royal-027", name: "White Tight Vest + Royal Blue Pleated Mini Skirt", translation: "화이트 타이트 조끼 + 로열 블루 플리츠 미니스커트", categories: ["ROYAL"] },
  { id: "royal-028", "name": "Ivory Silk Tie-neck Blouse + Black Leather Micro Skirt", translation: "아이보리 실크 타이넥 블라우스 + 블랙 가죽 마이크로 스커트", categories: ["ROYAL"] },
  { id: "royal-029", name: "Royal Blue Mesh Overlay + White Denim Shorts", translation: "로열 블루 메쉬 오버레이 + 화이트 데님 숏팬츠", categories: ["ROYAL"] },
  { id: "royal-030", name: "Navy Tweed Sleeveless Matching Set", translation: "네이비 트위드 민소매 매칭 세트", categories: ["ROYAL"] },
  { id: "royal-031", name: "Emerald Green Velvet Wrap Dress with Silver Buckle", translation: "에메랄드 그린 벨벳 랩 드레스 (실버 버클)", categories: ["ROYAL"] },
  { id: "royal-032", name: "White Organza Ruffle Blouse + Navy High-waist Mini", translation: "화이트 오간자 러플 블라우스 + 네이비 하이웨이스트 미니", categories: ["ROYAL"] },
  { id: "royal-033", name: "Royal Blue Silk Cami + Champagne Mini Skirt", translation: "로열 블루 실크 캐미솔 + 샴페인 미니스커트", categories: ["ROYAL"] },
  { id: "royal-034", name: "Emerald Green Silk Wrap Blouse + Black Satin Skirt", translation: "에메랄드 그린 실크 랩 블라우스 + 블랙 새틴 스커트", categories: ["ROYAL"] },
  { id: "royal-035", name: "Burgundy Velvet Off-shoulder Dress + Gold Waist Chain", translation: "버건디 벨벳 오프숄더 드레스 (골드 허리 체인)", categories: ["ROYAL"] },
  { id: "royal-036", name: "Champagne Gold Halter Neck Top + White Silk Micro Skirt", translation: "샴페인 골드 홀터넥 탑 + 화이트 실크 마이크로 스커트", categories: ["ROYAL"] },
  { id: "royal-037", name: "Pearl Pink Tweed Jacket Style Mini Dress", translation: "펄 핑크 트위드 재킷 스타일 미니 드레스", categories: ["ROYAL"] },
  { id: "royal-038", name: "Lavender Chiffon Ruffle Top + Silver Grey Mini Skirt", translation: "라벤더 시폰 러플 탑 + 실버 그레이 미니스커트", categories: ["ROYAL"] },
  { id: "royal-039", name: "Charcoal Grey Cashmere Sleeveless + Black Leather Mini Skirt", translation: "차콜 그레이 캐시미어 민소매 + 블랙 가죽 미니스커트", categories: ["ROYAL"] },
  { id: "royal-040", name: "Chocolate Brown Satin Slip Dress + Ivory Lace Trim", translation: "초콜릿 브라운 새틴 슬립 드레스 (아이보리 레이스)", categories: ["ROYAL"] },
  { id: "royal-041", name: "Midnight Purple One-shoulder Tight Knit Dress", translation: "미드나잇 퍼플 원숄더 타이트 니트 드레스", categories: ["ROYAL"] },
  { id: "royal-042", name: "Olive Green Silk Shirt + Tan High-waist Mini Skirt", translation: "올리브 그린 실크 셔츠 + 탄색 하이웨이스트 미니스커트", categories: ["ROYAL"] },
  { id: "royal-043", name: "Copper Metallic Fitted Top + Black Micro Skirt", translation: "코퍼 메탈릭 피티드 탑 + 블랙 마이크로 스커트", categories: ["ROYAL"] },
  { id: "royal-044", name: "Deep Teal Velvet Bodysuit + Champagne Gold Mini Skirt", translation: "딥 틸 벨벳 바디수트 + 샴페인 골드 미니스커트", categories: ["ROYAL"] },
  { id: "royal-045", name: "Magenta Silk Neck-tie Blouse + Black Pencil Mini Skirt", translation: "마젠타 실크 넥타이 블라우스 + 블랙 펜슬 미니스커트", categories: ["ROYAL"] },
  { id: "royal-046", name: "Powder Blue Cashmere Turtleneck + White Plaid Mini Skirt", translation: "파우더 블루 캐시미어 터틀넥 + 화이트 체크 미니스커트", categories: ["ROYAL"] },
  { id: "royal-047", name: "Peach Satin Cross-neck Top + Rose Gold Mini Skirt", translation: "피치 새틴 크로스넥 탑 + 로즈 골드 미니스커트", categories: ["ROYAL"] },
  { id: "royal-048", name: "Mustard Yellow Silk Cami + Charcoal Grey Mini Skirt", translation: "머스타드 옐로우 실크 캐미솔 + 차콜 그레이 미니스커트", categories: ["ROYAL"] },
  { id: "royal-049", name: "Forest Green Lace Overlay Top + Ivory Satin Skirt", translation: "포레스트 그린 레이스 오버레이 탑 + 아이보리 새틴 스커트", categories: ["ROYAL"] },
  { id: "royal-050", name: "Gunmetal Silver Sequin Mini Dress", translation: "건메탈 실버 시퀸 미니 드레스", categories: ["ROYAL"] },
  { id: "royal-051", name: "Mauve Silk Wrap Mini Dress", translation: "모브 핑크 실크 랩 미니 드레스", categories: ["ROYAL"] },
  { id: "royal-052", name: "Tan Suede Sleeveless Top + White Denim Micro Shorts", translation: "탄색 스웨이드 민소매 탑 + 화이트 데님 마이크로 숏팬츠", categories: ["ROYAL"] },
  { id: "royal-053", name: "Coral Pink Organza Top + White Leather Mini Skirt", translation: "코랄 핑크 오간자 탑 + 화이트 가죽 미니스커트", categories: ["ROYAL"] },
  ...
  { id: "golf-025a", name: "Sleeveless V-neck knit top and matching high-waisted knit mini skirt two-piece set. Large-scale classic Argyle diamond pattern in warm beige, cream white, and soft taupe with thin diagonal stitch lines. V-neckline showing collarbone, ribbed hem. Mini skirt ending mid-thigh. Soft fine-gauge knit wool-blend fabric with smooth matte finish. Bare legs below the skirt", translation: "아가일 니트 V넥 탑 + 미니스커트 세트 (베이지&화이트)", categories: ["GOLF LUXURY"] },
  { id: "golf-025b", name: "Sleeveless V-neck crop top and matching high-waisted full-length leggings two-piece athletic set. Large-scale Houndstooth check pattern in warm camel beige and cream white. V-neckline crop top ending just above the natural waist. High-waisted leggings skin-tight from hip to ankle. Stretchy performance knit fabric with smooth opaque matte finish", translation: "하운드투스 V넥 크롭탑 + 레깅스 세트 (베이지&화이트)", categories: ["GOLF LUXURY"] },
  { id: "golf-025c", name: "Sleeveless V-neck one-piece bodysuit catsuit. Small-scale repeating diamond checker pattern in soft beige and cream white. V-neckline, skin-tight from shoulder to ankle as a single seamless piece with no visible waist seam. Smooth stretch jersey fabric with opaque matte finish", translation: "다이아몬드 체크 V넥 바디수트 (베이지&화이트)", categories: ["GOLF LUXURY"] },
