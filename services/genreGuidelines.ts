...
⚡ **황당 상황 카테고리**:
* **몸의 배신**: 갑자기 안 들리는 귀, 침침한 눈, 삐끗하는 허리
* **디지털 문화**: 스마트폰 오작동, SNS 실수, 배달앱 헤매기
* **일상 실수**: 마트에서 카트 잘못 가져감, 약속 날짜 착각, 이름 깜빡
* **세대 차이**: MZ세대 용어 몰라서 생긴 오해, 요즘 문화 적응 실패
* **부부 일상**: 부부싸움 후 어색한 상황, 배우자 몰래 뭔가 하다 들킴
* **취미생활**: 골프/등산/낚시 등에서 생긴 초보 티 폭발 순간

🔥 **구조 (10-12문장)**:
1. **Hook**: 황당한 상황 선언 ("오늘 헬스장에서 진짜 쪽팔린 일이 생겼어")
2. **Setup**: 배경 설명 ("요즘 살 좀 빼려고 PT를 시작했거든")
3. **Build-up**: 상황 악화 ("트레이너가 플랭크 자세를 알려주는데...")
4. **Climax**: 절정 ("갑자기 허리가 삐끗했어")
5. **Twist**: 반전/펀치라인 ("알고 보니 내가 입은 게 바지가 아니라 딸 레깅스였대")
...
⚡ **예시 (참고만 할 것)**:
"마트에서 카트에 장 가득 담았는데 계산하려고 보니 내 카트가 아니더라고.
당황해서 주변을 둘러보는데 누가 내 카트를 밀고 가는 거야.
뛰어가서 '저기요!' 하고 불렀더니 그 사람도 나랑 똑같은 상황이었어.
우리 둘이 서로 카트를 바꿔서 쓰고 있었던 거지.
이게 뭐야 진짜, 나이 들면 눈도 침침해지나 봐."
...
⚡ **실제 예시 (참고만 할 것)**:
"오늘따라 준호 씨의 뒷모습이 유난히 낯설게 느껴졌어.
평소처럼 레슨을 받는데, 그의 손이 내 장갑 위로 겹쳐지더라고.
'준호 씨, 오늘 좀 이상하네?' 내가 농담처럼 던진 말에 정적이 흘렀어.
그가 가만히 나를 내려다보는데, 숨이 멎는 것 같았지.
'너만 모르는 거야, 아니면 모르는 척하는 거야?'
그 한마디에 심장이 제멋대로 뛰기 시작했어.
이게 뭐야 진짜, 우리 그냥 편한 사이 아니었어?"
`
   },
