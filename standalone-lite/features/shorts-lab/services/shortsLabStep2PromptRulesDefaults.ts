...
**⚠️ 샷 타입 분배 규칙 (매우 중요!):**
1. **원샷(1인물)은 전체의 약 20%만 사용** (2~3개)
2. **투샷/쓰리샷(2~4인물)은 전체의 약 80%** (8~10개)
3. 등장인물이 4명일 때는 ** group shot 또는 4인 멀티샷 활용**
4. **멀티샷 예시**: "[Person 1: ... action1] [Person 2: ... action2] [Person 3: ... action3] [Person 4: ... action4]"

**⚠️ 앵글 다양성 강제 규칙:**
1) **미디움샷(medium shot) 3회 연속 사용 절대 금지**
2) **전신샷(Full-body/Wide) 최소 3회 포함** (쇼츠 세로 화면에서 배경이 잘 보이도록)
3) **익스트림 클로즈업(Extreme close-up) 1회 이상 권장** (강한 감정 표현)
4) **POV는 절대 사용 금지** (문제太多) → 대신 wide/OTS 사용
